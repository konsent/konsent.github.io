...
- [솔로 규칙서 2 출처: BGG 포럼(단순 기계 번역)](/wepapps/downtown/solo sop/downtown_solo3_Kimi.html)
- [솔로 규칙서 2용 솔리테어 참조표 출처: BGG 포럼(단순 기계 번역)](/wepapps/downtown/solo sop/downtown_bot_aid_KOR_Kimi.html)
