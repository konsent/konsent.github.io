...
- 각각 숨겨진 비밀 목표가 있어서 서로 믿을 수 없는 것이 꿀잼 포인트(영화랑 비슷하다)
- 룰마스터가 고생하면 다른 사람들은 편하게 게임할 수 있음.
- 기본으로 주어지는 임무가 너무 단순해서 따로 더 만들었음(매우 만족)
